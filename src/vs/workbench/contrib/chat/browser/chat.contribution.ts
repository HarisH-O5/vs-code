...
import { ReadImageToolContribution } from './tools/readImageTool.js';
...
registerWorkbenchContribution2(ReadImageToolContribution.ID, ReadImageToolContribution, WorkbenchPhase.Eventually);
