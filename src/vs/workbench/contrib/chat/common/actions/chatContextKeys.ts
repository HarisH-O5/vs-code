...
export namespace ChatContextKeys {
	...
	export const agentSessionType = new RawContextKey<string>('agentSessionType', '', { type: 'string', description: localize('agentSessionType', "The type of the current agent session item.") });
